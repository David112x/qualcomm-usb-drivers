...
#define EXCLISIVE_MB_ACCESS   0x00
#define EXCLISIVE_APP_ACCESS  0x01
#define SHARED_ACCESS         0x02 
#define SHARED_APP_PRECEDENCE 0x03
//#define SHARED_MB_PRECEDENCE  0x04  /* This is not possible */
#define ACCESS_MAX            0x04
...
#define USB_INTERNAL_READ_BUFFER_SIZE      16*(8*QCSER_RECEIVE_BUFFER_SIZE)
...
#define WRITE_AGGREGATE_EVENT_INDEX      12
#define WRITE_EVENT_COUNT                13
...
#define INT_IDLENESS_COMPLETED_EVENT     12
#define INT_IDLE_CBK_COMPLETED_EVENT     13
#define INT_PIPE_EVENT_COUNT             14
...
#define DSP_REQ_D0_EVENT_INDEX           9
#define DSP_EVENT_COUNT                  10

// Filter event indexes
#define FILTER_STOP_EVENT_INDEX           1
#define FILTER_START_READ_EVENT_INDEX     2
#define FILTER_STOP_READ_EVENT_INDEX      3
#define FILTER_START_WRITE_EVENT_INDEX    4
#define FILTER_STOP_WRITE_EVENT_INDEX     5
#define FILTER_RD_COMPLETION_EVENT_INDEX  6
#define FILTER_WT_COMPLETION_EVENT_INDEX  7
#define FILTER_READ_COMPLETION_EVENT_INDEX  8
#define FILTER_WRITE_COMPLETION_EVENT_INDEX 9
#define FILTER_CREATE_COMPLETION_EVENT_INDEX  10
#define FILTER_CLOSE_COMPLETION_EVENT_INDEX 11
#define FILTER_SETTIMEOUT_COMPLETION_EVENT_INDEX  12
#define FILTER_READ_CANCEL_EVENT_INDEX     13
#define FILTER_EVENT_COUNT                  14

#define FILTER_DRIVER_READ_EVENT_NAME   L"\\KernelObjects\\QCFILTERDRIVERREAD"
#define FILTER_DRIVER_CANCEL_EVENT_NAME L"\\KernelObjects\\QCFILTERDRIVERCANCEL"
#define FILTER_FILE_OBJECT_NAME         L"QCFilterFileName"
...
typedef enum _FILTER_STATE
{
   ...
   FILTER_STARTED,
   FILTER_READ_PENDING,
   FILTER_CREATE_PENDING,
   FILTER_WRITE_MODEM_PENDING,
   FILTER_SETTIMEOUT_MODEM_PENDING,
   FILTER_READ_MODEM_PENDING,
   FILTER_CLOSE_MODEM_PENDING,
   FILTER_WRITE_PENDING,
   FILTER_READ_STOP
}FILTER_STATE;
...
#define QCUSB_AGG_BUF_SIZE 1024*20
#define QC_AVAILABLE_AGG_BYTES (pDevExt->WriteAggBuffer.MaxSize - pDevExt->WriteAggBuffer.CurrentCount)
#define QC_DEST_AGG_BUF ((PCHAR)pDevExt->WriteAggBuffer.Buffer+pDevExt->WriteAggBuffer.CurrentCount)
...
typedef struct _DEVICE_EXTENSION
{
   ...
   LONG           ActivityInProgress;
   // #endif // QCSER_SYNC_DISPATCH_AND_ADD_DEV

   #ifdef QCUSB_SUPPORT_STACK_OPEN_CLOSE
   PFILE_OBJECT   PortFileObject;
   PIRP           PortOpenIrp;
   PIRP           PortCloseIrp;
   #endif // QCUSB_SUPPORT_STACK_OPEN_CLOSE
   ...
   ULONG              SystemWakeupLevel;     // host side
   LIST_ENTRY         DevicePowerRequestQueue;
   ...
   // not to expect to receive >4 back-to-back sys pwr IRPs
   ...
   ***********************/
   ...
   BOOLEAN bAggDispatch;
   QCUSB_AGG_BUFFER  WriteAggBuffer;
   
   KEVENT WriteAggregateEvent;
   KTIMER AggregateTimer;
   KDPC   AggregateDpc;
   ULONG  AggregationPeriod;
   ULONG  TimerResolutionSet;   
